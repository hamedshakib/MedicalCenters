...
{
    internal class MedicineQueryHandler(IMedicineRepository medicineRepository, IMapper mapper) : IQueryHandler<MedicineQuery, BaseQueryResponse>
    {
    ...
    public record class MedicineQuery : IQuery<BaseQueryResponse>
    {
